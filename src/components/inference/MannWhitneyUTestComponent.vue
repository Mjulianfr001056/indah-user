<template>
    <div>
        ...
        <div class="d-flex flex-column justify-center w-auto mb-10 ml-5">
            ...
            <p><strong>W</strong>: {{ W }}, <strong>p-value</strong>: {{ pValue }}</p>
...
export default {
    ...
    mounted() {
        ...
        axios.post(API_ENDPOINT + 'inference/mann-whitney', HEADER)
            .then(response => {
                function roundToThreeDecimalPlaces(value) {
                    return Number.isInteger(value) ? value : value.toFixed(3);
                }

                this.W = roundToThreeDecimalPlaces(response.data.entity.w);
